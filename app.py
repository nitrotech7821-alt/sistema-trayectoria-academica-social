...
def conectar_firebase():
    ...
    # STREAMLIT CLOUD:
    # En Manage app > Settings > Secrets pega el JSON así:
    #
    # firebase_service_account = """
    # {
    #   "type": "service_account",
    #   "project_id": "dif-hermosillo",
    #   ...
    # }
    # """
    if "firebase_service_account" in st.secrets:
        try:
            ...
            st.error(f"Error Firebase Secrets: {e}")
            return None

    # LOCAL:
    # Coloca el archivo JSON en la misma carpeta del app.py
    ...
    st.error("No se encontró Firebase. Configura firebase_service_account en Secrets.")
    return None
